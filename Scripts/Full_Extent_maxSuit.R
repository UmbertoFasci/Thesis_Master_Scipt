...
Current_Avg_preds_binary <- ggplot(data = Current_Avg_df, aes(x=Longitude, y=Latitude)) +
  ...
  theme(legend.title = element_blank(),
        legend.key.size = unit(6, "mm"), legend.text = element_text(size = 6),
        panel.border = element_rect(colour = "black", size = 0.5)) + 
  geom_tile(aes(fill = `Suitability_Levels`, alpha = 0.3), data = subset.data.frame(Current_maxSuit$Suitability_Levels == 4))
...
MRIESM2_1140_126_Avg_preds_binary <- ggplot(data = MRIESM2_1140_126_Avg_df, aes(x=Longitude, y=Latitude)) +
  ...
  theme(legend.title = element_blank(),
        legend.key.size = unit(6, "mm"), legend.text = element_text(size = 6),
        panel.border = element_rect(colour = "black", size = 0.5)) +
  geom_tile(aes(fill = `Suitability_Levels`, alpha = 0.3), data = subset.data.frame(MRIESM2_1140_126_maxSuit$Suitability_Levels == 4))
...
MRIESM2_1140_585_Avg_preds_binary <- ggplot(data = MRIESM2_1140_585_Avg_df, aes(x=Longitude, y=Latitude)) +
  ...
  theme(legend.title = element_blank(),
        legend.key.size = unit(6, "mm"), legend.text = element_text(size = 6),
        panel.border = element_rect(colour = "black", size = 0.5)) +
  geom_tile(aes(fill = `Suitability_Levels`, alpha = 0.3), data = subset.data.frame(MRIESM2_1140_585_maxSuit$Suitability_Levels == 4))
...
MRIESM2_4170_126_Avg_preds_binary <- ggplot(data = MRIESM2_4170_126_Avg_df, aes(x=Longitude, y=Latitude)) +
  ...
  theme(legend.title = element_blank(),
        legend.key.size = unit(6, "mm"), legend.text = element_text(size = 6),
        panel.border = element_rect(colour = "black", size = 0.5)) +
  geom_tile(aes(fill = `Suitability_Levels`, alpha = 0.3), data = subset.data.frame(MRIESM2_4170_126_maxSuit$Suitability_Levels == 4))
...
MRIESM2_4170_585_Avg_preds_binary <- ggplot(data = MRIESM2_4170_585_Avg_df, aes(x=Longitude, y=Latitude)) +
  ...
  theme(legend.title = element_blank(),
        legend.key.size = unit(6, "mm"), legend.text = element_text(size = 6),
        panel.border = element_rect(colour = "black", size = 0.5)) +
  geom_tile(aes(fill = `Suitability_Levels`, alpha = 0.3), data = subset.data.frame(MRIESM2_4170_585_maxSuit$Suitability_Levels == 4))
