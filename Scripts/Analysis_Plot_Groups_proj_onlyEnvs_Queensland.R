...
Annual_Mean_Temp_1140_585_Queensland_df <- Annual_Mean_Temp_2011_2040_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Annual_Mean_Temp_1140_585_Queensland_df <- Annual_Mean_Temp_1140_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Diurnal_Range_1140_585_Queensland_df <- Mean_Diurnal_Range_2011_2040_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Diurnal_Range_1140_585_Queensland_df <- Mean_Diurnal_Range_1140_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Isothermality_1140_585_Queensland_df <- Isothermality_2011_2040_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Isothermality_1140_585_Queensland_df <- Isothermality_1140_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Temp_Driest_Qtr_1140_585_Queensland_df <- Mean_Temp_Driest_Qtr_2011_2040_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Temp_Driest_Qtr_1140_585_Queensland_df <- Mean_Temp_Driest_Qtr_1140_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Prec_of_Wettest_Month_1140_585_Queensland_df <- Prec_of_Wettest_Month_2011_2040_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Prec_of_Wettest_Month_1140_585_Queensland_df <- Prec_of_Wettest_Month_1140_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))
...
Annual_Mean_Temp_4170_126_Queensland_df <- Annual_Mean_Temp_2041_2070_126_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Annual_Mean_Temp_4170_126_Queensland_df <- Annual_Mean_Temp_4170_126_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Diurnal_Range_4170_126_Queensland_df <- Mean_Diurnal_Range_2041_2070_126_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Diurnal_Range_4170_126_Queensland_df <- Mean_Diurnal_Range_4170_126_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Isothermality_4170_126_Queensland_df <- Isothermality_2041_2070_126_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Isothermality_4170_126_Queensland_df <- Isothermality_4170_126_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Temp_Driest_Qtr_4170_126_Queensland_df <- Mean_Temp_Driest_Qtr_2041_2070_126_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Temp_Driest_Qtr_4170_126_Queensland_df <- Mean_Temp_Driest_Qtr_4170_126_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Prec_of_Wettest_Month_4170_126_Queensland_df <- Prec_of_Wettest_Month_2041_2070_126_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Prec_of_Wettest_Month_4170_126_Queensland_df <- Prec_of_Wettest_Month_4170_126_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))
...
Annual_Mean_Temp_4170_585_Queensland_df <- Annual_Mean_Temp_2041_2070_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Annual_Mean_Temp_4170_585_Queensland_df <- Annual_Mean_Temp_4170_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Diurnal_Range_4170_585_Queensland_df <- Mean_Diurnal_Range_2041_2070_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Diurnal_Range_4170_585_Queensland_df <- Mean_Diurnal_Range_4170_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Isothermality_4170_585_Queensland_df <- Isothermality_2041_2070_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Isothermality_4170_585_Queensland_df <- Isothermality_4170_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Mean_Temp_Driest_Qtr_4170_585_Queensland_df <- Mean_Temp_Driest_Qtr_2041_2070_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Mean_Temp_Driest_Qtr_4170_585_Queensland_df <- Mean_Temp_Driest_Qtr_4170_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))

Prec_of_Wettest_Month_4170_585_Queensland_df <- Prec_of_Wettest_Month_2041_2070_585_df %>% 
    filter(between(Longitude, 138.00, 155.00))
Prec_of_Wettest_Month_4170_585_Queensland_df <- Prec_of_Wettest_Month_4170_585_Queensland_df %>% 
    filter(between(Latitude, -29.00, -9.00))
...
MRIESM2_1140_126_Avg_Queensland_df <- MRIESM2_1140_126_Avg_df %>%
  filter(between(Longitude, 138.00, 155.00))
MRIESM2_1140_126_Avg_Queensland_df <- MRIESM2_1140_126_Avg_Queensland_df %>%
  filter(between(Latitude, -29.00, -9.00))

MRIESM2_1140_126_Stats_Queensland <- MRIESM2_1140_126_Avg_Queensland_df
MRIESM2_1140_126_Stats_Queensland$Annual_Mean_Temp_2011_2040_126 <- Annual_Mean_Temp_1140_126_Queensland_df$Annual_Mean_Temp_2011_2040_126
MRIESM2_1140_126_Stats_Queensland$Mean_Diurnal_Range_2011_2040_126 <- Mean_Diurnal_Range_1140_126_Queensland_df$Mean_Diurnal_Range_2011_2040_126
MRIESM2_1140_126_Stats_Queensland$Isothermality_2011_2040_126 <- Isothermality_1140_126_Queensland_df$Isothermality_2011_2040_126
MRIESM2_1140_126_Stats_Queensland$Mean_Temp_Driest_Qtr_2011_2040_126 <- Mean_Temp_Driest_Qtr_1140_126_Queensland_df$Mean_Temp_Driest_Qtr_2011_2040_126
MRIESM2_1140_126_Stats_Queensland$Prec_of_Wettest_Month_2011_2040_126 <- Prec_of_Wettest_Month_1140_126_Queensland_df$Prec_of_Wettest_Month_2011_2040_126


# 2011-2040 ssp585

MRIESM2_1140_585_Avg_Queensland_df <- MRIESM2_1140_585_Avg_df %>%
  filter(between(Longitude, 138.00, 155.00))
MRIESM2_1140_585_Avg_Queensland_df <- MRIESM2_1140_585_Avg_Queensland_df %>%
  filter(between(Latitude, -29.00, -9.00))

MRIESM2_1140_585_Stats_Queensland <- MRIESM2_1140_585_Avg_Queensland_df
MRIESM2_1140_585_Stats_Queensland$Annual_Mean_Temp_2011_2040_585 <- Annual_Mean_Temp_1140_585_Queensland_df$Annual_Mean_Temp_2011_2040_585
MRIESM2_1140_585_Stats_Queensland$Mean_Diurnal_Range_2011_2040_585 <- Mean_Diurnal_Range_1140_585_Queensland_df$Mean_Diurnal_Range_2011_2040_585
MRIESM2_1140_585_Stats_Queensland$Isothermality_2011_2040_585 <- Isothermality_1140_585_Queensland_df$Isothermality_2011_2040_585
MRIESM2_1140_585_Stats_Queensland$Mean_Temp_Driest_Qtr_2011_2040_585 <- Mean_Temp_Driest_Qtr_1140_585_Queensland_df$Mean_Temp_Driest_Qtr_2011_2040_585
MRIESM2_1140_585_Stats_Queensland$Prec_of_Wettest_Month_2011_2040_585 <- Prec_of_Wettest_Month_1140_585_Queensland_df$Prec_of_Wettest_Month_2011_2040_585


# 2041-2070 ssp126

MRIESM2_4170_126_Avg_Queensland_df <- MRIESM2_4170_126_Avg_df %>%
  filter(between(Longitude, 138.00, 155.00))
MRIESM2_4170_126_Avg_Queensland_df <- MRIESM2_4170_126_Avg_Queensland_df %>%
  filter(between(Latitude, -29.00, -9.00))

MRIESM2_4170_126_Stats_Queensland <- MRIESM2_4170_126_Avg_Queensland_df
MRIESM2_4170_126_Stats_Queensland$Annual_Mean_Temp_2041_2070_126 <- Annual_Mean_Temp_4170_126_Queensland_df$Annual_Mean_Temp_2041_2070_126
MRIESM2_4170_126_Stats_Queensland$Mean_Diurnal_Range_2041_2070_126 <- Mean_Diurnal_Range_4170_126_Queensland_df$Mean_Diurnal_Range_2041_2070_126
MRIESM2_4170_126_Stats_Queensland$Isothermality_2041_2070_126 <- Isothermality_4170_126_Queensland_df$Isothermality_2041_2070_126
MRIESM2_4170_126_Stats_Queensland$Mean_Temp_Driest_Qtr_2041_2070_126 <- Mean_Temp_Driest_Qtr_4170_126_Queensland_df$Mean_Temp_Driest_Qtr_2041_2070_126
MRIESM2_4170_126_Stats_Queensland$Prec_of_Wettest_Month_2041_2070_126 <- Prec_of_Wettest_Month_4170_126_Queensland_df$Prec_of_Wettest_Month_2041_2070_126
...
MRIESM2_4170_585_Stats_Queensland$Annual_Mean_Temp_2041_2070_585 <- Annual_Mean_Temp_4170_585_Queensland_df$Annual_Mean_Temp_2041_2070_585
MRIESM2_4170_585_Stats_Queensland$Mean_Diurnal_Range_2041_2070_585 <- Mean_Diurnal_Range_4170_585_Queensland_df$Mean_Diurnal_Range_2041_2070_585
MRIESM2_4170_585_Stats_Queensland$Isothermality_2041_2070_585 <- Isothermality_4170_585_Queensland_df$Isothermality_2041_2070_585
MRIESM2_4170_585_Stats_Queensland$Mean_Temp_Driest_Qtr_2041_2070_585 <- Mean_Temp_Driest_Qtr_4170_585_Queensland_df$Mean_Temp_Driest_Qtr_2041_2070_585
MRIESM2_4170_585_Stats_Queensland$Prec_of_Wettest_Month_2041_2070_585 <- Prec_of_Wettest_Month_4170_585_Queensland_df$Prec_of_Wettest_Month_2041_2070_585
